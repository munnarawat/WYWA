        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              Meet the visionaries and relentless supporters who believed in the dream of empowering the youth and made MYWA a reality.
            </p>
          </motion.div>
        </div>
          ...
          {visionaries.map((person) => (
            ...
            >
              ...
              <div className="relative mb-6">
                <div className={`absolute -inset-1.5 bg-linear-to-br ${person.accent} rounded-full blur-sm opacity-50 group-hover:opacity-100 transition-opacity duration-500`} />
              ...
              <div className="flex items-center gap-4 mt-auto">
                <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all">
                  <Instagram size={18} />
                </a>
                <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all">
                  <Twitter size={18} />
