        ...
        <motion.div
          ...
          {loading
            ? [...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="relative group rounded-[28px] border border-white/10 h-100 w-full bg-white/5 p-8 overflow-hidden flex flex-col ease-out items-center text-center">
                  <div className="w-36 h-36 rounded-full bg-white/10 animate-pulse mb-5" />
                  <div className="h-6 w-full bg-white/10 animate-pulse rounded mb-2" />
                  <div className="h-4 w-full bg-white/10 animate-pulse rounded" />
                  <div className="h-16 w-full bg-white/10 animate-pulse rounded mt-2" />
                </div>
              ))
