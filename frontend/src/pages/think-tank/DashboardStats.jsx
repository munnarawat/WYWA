...
const STATS_CONFIG = [
  {
    ...
    icon: Users,
    cardGradient:
      "linear-gradient(135deg, rgba(59,130,246,0.3), rgba(255,255,255,0.04), rgba(99,102,241,0.15))",
        ...
        (
          ...
          <motion.div
            ...
            <div className="bg-[#0d1117] rounded-[19px] p-5 relative overflow-hidden min-h-35">
              ...
              {/* Icon */}
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center border mb-3 ${iconClass}`}>
                <Icon size={18} />
              </div>
