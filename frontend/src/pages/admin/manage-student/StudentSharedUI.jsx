    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute right-0 -top-25 md:right-0 mt-2 w-52 rounded-[14px] md:top-8 overflow-hidden z-50 bg-[#0d1117] border border-white/8 shadow-[0_16px_40px_rgba(0,0,0,0.6)]">
          <button
